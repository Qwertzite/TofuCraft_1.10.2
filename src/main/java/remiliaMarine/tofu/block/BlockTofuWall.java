...
public class BlockTofuWall extends TcBlock implements IBlockTofuMaterial {
    ...
    {
        super(tofuMaterial.getBlock().getDefaultState().getMaterial());
    ...
    public boolean canConnectTo(IBlockAccess worldIn, BlockPos pos)
    {
        ...
        return block == Blocks.BARRIER ? false : (block != this && !(block instanceof BlockTofuFenceGate && ((IBlockTofuMaterial)block).getTofuMaterial() == this.tofuMaterial) ? (iblockstate.getMaterial().isOpaque() && iblockstate.isFullCube() ? iblockstate.getMaterial() != Material.GOURD : false) : true);
    }
    ...
    public String getLocalizedName() {
        ...
        return (I18n.translateToLocalFormatted(this.getUnlocalizedName() + ".name",
    ...
    {
        return this.tofuMaterial.getBlock().getBlockLayer();
    }
