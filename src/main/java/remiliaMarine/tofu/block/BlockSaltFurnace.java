...
public class BlockSaltFurnace extends TcBlockContainer {
    ...
    {
        {
            ...
            {
            	playerIn.openGui(TofuCraftCore.INSTANCE, TcGuiHandler.GUIID_SALT_FURNACE, worldIn, pos.getX(), pos.getY(), pos.getZ());
    ...
    public static void setState(boolean active, World worldIn, BlockPos pos)
    {
        ...
        if (active)
        {
            worldIn.setBlockState(pos, TcBlocks.saltFurnaceActive.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
            worldIn.setBlockState(pos, TcBlocks.saltFurnaceActive.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
        }
        else
        {
            worldIn.setBlockState(pos, TcBlocks.saltFurnaceIdle.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
            worldIn.setBlockState(pos, TcBlocks.saltFurnaceIdle.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
        }
    ...
    {
        return new ItemStack(TcBlocks.saltFurnaceIdle);
    }
	...
	public static void updateFurnaceBlockState(boolean b, World worldObj, BlockPos pos) {
        ...
        if (b)
        {
        	worldObj.setBlockState(pos, TcBlocks.saltFurnaceActive.getDefaultState().withProperty(BlockSaltFurnace.FACING, blockstate.getValue(BlockSaltFurnace.FACING)));
        }
        else
        {
        	worldObj.setBlockState(pos, TcBlocks.saltFurnaceIdle.getDefaultState().withProperty(BlockSaltFurnace.FACING, blockstate.getValue(BlockSaltFurnace.FACING)));
