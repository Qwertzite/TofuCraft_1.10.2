...
import remiliaMarine.tofu.tileentity.SlotSaltFurnace;
...
public class ContainerSaltFurnace extends Container{
    ...
    public void detectAndSendChanges()
    {
        ...
        for (int i = 0; i < this.listeners.size(); ++i)
        {
            ...
            {
                icontainerlistener.sendProgressBarUpdate(this, 2, this.tileSaltFurnace.getField(2));
            }

            if (this.furnaceBurnTime != this.tileSaltFurnace.getField(0))
            {
                icontainerlistener.sendProgressBarUpdate(this, 0, this.tileSaltFurnace.getField(0));
            }

            if (this.currentItemBurnTime != this.tileSaltFurnace.getField(1))
            {
                icontainerlistener.sendProgressBarUpdate(this, 1, this.tileSaltFurnace.getField(1));
            }

            if (this.totalCookTime != this.tileSaltFurnace.getField(3))
            {
                icontainerlistener.sendProgressBarUpdate(this, 3, this.tileSaltFurnace.getField(3));
            }
        }
    ...
    {
        return this.tileSaltFurnace.isUseableByPlayer(playerIn);
    }
    ...
    public ItemStack transferStackInSlot(EntityPlayer par1EntityPlayer, int index)
    {
        ...
        if (slot != null && slot.getHasStack())
        {
            ...
            if (ItemStackAdapter.getSize(itemStack1) == 0)
            {
            ...
            if (ItemStackAdapter.getSize(itemStack1) == ItemStackAdapter.getSize(itemStack))
            {
                return null;
            }
