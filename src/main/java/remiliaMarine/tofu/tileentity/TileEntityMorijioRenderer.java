...
import remiliaMarine.tofu.model.ModelMorijio;

public class TileEntityMorijioRenderer extends TileEntitySpecialRenderer<TileEntity> {
...
//                    par5 = 90.0F;
    ...
    {
        this.renderTileEntityMorijioAt((TileEntityMorijio)te, x, y, z, partialTicks);
    }
}
