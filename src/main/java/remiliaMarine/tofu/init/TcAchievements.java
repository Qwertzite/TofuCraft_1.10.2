...
public class TcAchievements {
    public static void load()
    {
        ...
        TcAchievement.create(Key.ishiTofu, 7, -2, TcItems.tofuIshi, Key.momenTofu)
        ...
        TcAchievement.create(Key.hiyayakko, 2, 4, new ItemStack(TcItems.foodSet, 1, ItemFoodSet.EnumSetFood.HIYAYAKKO.getId()), Key.leek)
                .setTriggerItemCrafting(new ItemStack(TcItems.foodSet, 1, ItemFoodSet.EnumSetFood.HIYAYAKKO.getId()))
                .setTriggerItemCrafting(new ItemStack(TcItems.foodSet, 1, ItemFoodSet.EnumSetFood.HIYAYAKKO_GL.getId()))
                .registerStat();
        ...
        TcAchievement.create(Key.soboroTofu, 5, -3, ItemFoodSet.EnumSetFood.TOFU_MINCED.getStack(), Key.momenTofu)
                .setTriggerItemCrafting(ItemFoodSet.EnumSetFood.TOFU_MINCED.getStack())
                .registerStat();
        ...
        // === salt ===
        TcAchievement.create(Key.saltPan, -2, 1, TcBlocks.saltPan, null)
                .setTriggerItemCrafting(new ItemStack(TcBlocks.saltPan))
                .registerStat();

        TcAchievement.create(Key.baySalt, -1, 2, TcItems.salt, Key.saltPan)
                .registerStat();

        TcAchievement.create(Key.bayBittern, -1, 3, TcItems.nigari, Key.saltPan)
                .registerStat();

        TcAchievement.create(Key.saltFurnace, -2, 4, TcBlocks.saltFurnaceIdle, null)
                .setTriggerItemCrafting(new ItemStack(TcBlocks.saltFurnaceIdle))
                .registerStat();

        TcAchievement.create(Key.salt, -1, 5, TcItems.salt, Key.saltFurnace)
                .registerStat();

        TcAchievement.create(Key.nigari, -1, 6, TcItems.nigari, Key.saltFurnace)
                .setTriggerItemCrafting(new ItemStack(TcItems.nigari))
                .registerStat();

        TcAchievement.create(Key.kiyome, -1, 8, Items.GLOWSTONE_DUST, null)
                .setTriggerItemCrafting(new ItemStack(TcItems.goldenSalt))
                .registerStat();

        TcAchievement.create(Key.morijio, -2, 8, TcItems.morijio, null)
        ...
        TcAchievement.create(Key.sprout, -7, 1, new ItemStack(TcItems.foodSet, 1, ItemFoodSet.EnumSetFood.SPROUTS.getId()), Key.sproutPlanting)
                .setTriggerItemPickup(new ItemStack(TcItems.foodSet, 1, ItemFoodSet.EnumSetFood.SPROUTS.getId()))
                .registerStat();

        TcAchievement.create(Key.sproutMeal, -9, 1, new ItemStack(TcItems.foodSet, 1, ItemFoodSet.EnumSetFood.SPROUT_SAUTE.getId()), Key.sprout)
                .setTriggerItemCrafting(new ItemStack(TcItems.foodSet, 1, ItemFoodSet.EnumSetFood.SPROUT_SAUTE.getId()))
                .registerStat();
        ...
        TcAchievement.create(Key.yakionigiriMiso, 4, -8, new ItemStack(TcItems.foodSet, 1, ItemFoodSet.EnumSetFood.YAKIONIGIRI_MISO.getId()), Key.miso)
                .setTriggerItemCrafting(new ItemStack(TcItems.foodSet, 1, ItemFoodSet.EnumSetFood.YAKIONIGIRI_MISO.getId()))
                .registerStat();

        TcAchievement.create(Key.goheimochi, 6, -8, new ItemStack(TcItems.foodSet, 1, ItemFoodSet.EnumSetFood.GOHEIMOCHI.getId()), Key.yakionigiriMiso)
                .setTriggerItemCrafting(new ItemStack(TcItems.foodSet, 1, ItemFoodSet.EnumSetFood.GOHEIMOCHI.getId()))
                .registerStat();
        ...
        TcAchievement.create(Key.yakionigiriShoyu, 4, -6, new ItemStack(TcItems.foodSet, 1, ItemFoodSet.EnumSetFood.YAKIONIGIRI_SHOYU.getId()), Key.soySauce)
                .setTriggerItemCrafting(new ItemStack(TcItems.foodSet, 1, ItemFoodSet.EnumSetFood.YAKIONIGIRI_SHOYU.getId()))
                .registerStat();
        ...
        // === Soymilk ===
        TcAchievement.create(Key.soymilkFv, 1, -2, new ItemStack(TcItems.bottleSoymilk, 1, SoymilkFlavour.RAMUNE.getId()), Key.soymilk)
                .setTriggerItemCrafting(new ItemStack(TcItems.bottleSoymilk, 1, SoymilkFlavour.RAMUNE.getId()))
                .registerStat();

        TcAchievement.create(Key.soymilk1st, 1, -4, new ItemStack(TcItems.bottleSoymilk, 1, SoymilkFlavour.PLAIN.getId()), Key.soymilk)
                .registerStat();

        TcAchievement.create(Key.soymilkWeek, 3, -4, new ItemStack(TcItems.bottleSoymilk, 1, SoymilkFlavour.COCOA.getId()), Key.soymilk1st)
                .registerStat();

        TcAchievement.create(Key.soymilkMax, 5, -4, new ItemStack(TcItems.bottleSoymilk, 1, SoymilkFlavour.ZUNDA.getId()), Key.soymilkWeek)
                .registerStat();
        ...
        TcAchievement.create(Key.oage, -7, 7, new ItemStack(TcItems.foodSet, 1, ItemFoodSet.EnumSetFood.OAGE.getId()), Key.soyOil)
                .setTriggerItemCrafting(new ItemStack(TcItems.foodSet, 1, ItemFoodSet.EnumSetFood.OAGE.getId()))
                .registerStat();

        TcAchievement.create(Key.oinarisan, -9, 7, new ItemStack(TcItems.foodSet, 1, ItemFoodSet.EnumSetFood.INARI.getId()), Key.oage)
                .setTriggerItemCrafting(new ItemStack(TcItems.foodSet, 1, ItemFoodSet.EnumSetFood.INARI.getId()))
                .registerStat();
        ...
        // === Tofu World ===
        TcAchievement.create(Key.tofuGem, 8, 4, ItemTcMaterials.EnumTcMaterialInfo.tofuGem.getStack(), null)
                .setTriggerItemPickup(new ItemStack(TcItems.materials, 1, ItemTcMaterials.EnumTcMaterialInfo.tofuGem.getMetadata()))
                .registerStat();
        ...
        TcAchievement.create(Key.tofuFishing, 17, 10, Items.FISHING_ROD, Key.tofuWorld)
                .setTriggerItemPickup(new ItemStack(TcItems.foodSet, 1, ItemFoodSet.EnumSetFood.TOFUFISH_RAW.getId()))
                .registerStat();
        ...
        TcAchievement.create(Key.tofunianHoe, 15, 14, TcItems.tofuHoe, Key.tofunian)
                .setSpecial()
                .registerStat();

        // === Tofu Force ===
        TcAchievement.create(Key.tfCapacitor, 6, 7, new ItemStack(TcItems.materials, 1, ItemTcMaterials.EnumTcMaterialInfo.tfCapacitor.getMetadata()), Key.tofuGem)
                .setTriggerItemCrafting(new ItemStack(TcItems.materials, 1, ItemTcMaterials.EnumTcMaterialInfo.tfCapacitor.getMetadata()))
                .registerStat();
        ...
        TcAchievement.create(Key.highPowerGem, 8, 10, new ItemStack(TcItems.materials, 1, ItemTcMaterials.EnumTcMaterialInfo.advTofuGem.getMetadata()), Key.tofuGem)
                .setTriggerItemPickup(new ItemStack(TcItems.materials, 1, ItemTcMaterials.EnumTcMaterialInfo.advTofuGem.getMetadata()))
                .registerStat();
        ...
        TcAchievement.create(Key.tofuActivation, 8, 13, new ItemStack(TcItems.materials, 1, ItemTcMaterials.EnumTcMaterialInfo.activatedTofuGem.getMetadata()), Key.tfCondenser)
                .setTriggerTfCondenser(new ItemStack(TcItems.materials, 1, ItemTcMaterials.EnumTcMaterialInfo.activatedTofuGem.getMetadata()))
                .registerStat();

        TcAchievement.create(Key.hellTofuActivation, 10, 13, new ItemStack(TcItems.materials, 1, ItemTcMaterials.EnumTcMaterialInfo.activatedHellTofu.getMetadata()), Key.tfCondenser)
                .setTriggerTfCondenser(new ItemStack(TcItems.materials, 1, ItemTcMaterials.EnumTcMaterialInfo.activatedHellTofu.getMetadata()))
                .registerStat();
        ...
        TcAchievement.create(Key.ultimateOven, 10, 16, new ItemStack(TcItems.materials, 1, ItemTcMaterials.EnumTcMaterialInfo.activatedHellTofu.getMetadata()), Key.tfOven)
                .setSpecial()
                .registerStat();
        ...
        {
            throw new IllegalStateException(String.format("Unregistered Achievements Found: %s", TcAchievementMgr.unregisteredKeys));
        }
    }
}
