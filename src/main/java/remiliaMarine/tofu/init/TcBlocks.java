...
public class TcBlocks {
    ...
    public static Block tofuStairsMiso;//moved from below
    ...
    public static BlockSlab tofuSingleSlabFaces;//TODO getVilageBlockIdEventHandler
    ...
    //public static Block tofuStairsMiso; moved
