...
public class TcItems {
    ...
    public static EnumMap<TofuMaterial, Item> TOFU_ITEMS = Maps.newEnumMap(TofuMaterial.class);
    ...
    //public static Item phialEmpty; unused
    ...
    public static Item zundaBow; //TODO add to tofu dungeon loot table ;count:1, weight 2
    ...
    //public static ItemFoodSetStick foodSetStick; moved foods to "foodSet"
    ...
    public static String getArmorName(String key, EntityEquipmentSlot armorType)
    {
    	int id = Utils.getIdFromEquipmentSlot(armorType);
        return TcItems.getArmorName(key, id);
    }
    public static String getArmorName(String key, int slot) {
        return "armor" + Utils.capitalize(key) + Utils.capitalize(armorNameList[slot]);
    }
