...
public class TcMapGenMineshaft extends TcMapGenStructure {
    ...
    public TcMapGenMineshaft(@SuppressWarnings("rawtypes") Map par1Map)
    {
    ...
    {
        return new StructureMineshaftStart(this.worldObj, this.rand, par1, par2, MapGenMineshaft.Type.NORMAL);
    }
