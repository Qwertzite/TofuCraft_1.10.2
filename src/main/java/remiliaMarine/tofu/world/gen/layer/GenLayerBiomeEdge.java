...
public class GenLayerBiomeEdge extends GenLayerTofu {
    ...
    public int[] getInts(int par1, int par2, int par3, int par4)
    {
        ...
        for (int i1 = 0; i1 < par4; ++i1)
        {
            for (int j1 = 0; j1 < par3; ++j1)
            {
                ...
                if (!this.func_151636_a(aint, aint1, j1, i1, par3, k1, Biome.getIdForBiome(TcBiomes.TOFU_EXTREME_HILLS), Biome.getIdForBiome(TcBiomes.TOFU_HILLS_EDGE)))
                {
                    aint1[j1 + i1 * par3] = k1;
                }
            }
    ...
    private boolean func_151634_b(int p_151634_1_, int p_151634_2_)
    {
        ...
        else if (BiomeTofu.getBiome(p_151634_1_) != null && BiomeTofu.getBiome(p_151634_2_) != null)
        {
            BiomeTofu.TempCategory tempcategory = BiomeTofu.getBiome(p_151634_1_).getTempCategory();
            BiomeTofu.TempCategory tempcategory1 = BiomeTofu.getBiome(p_151634_2_).getTempCategory();
