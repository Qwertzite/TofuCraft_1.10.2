...
public class GenLayerZoom extends GenLayerTofu {
    ...
    public static GenLayerTofu magnify(long par0, GenLayerTofu par2GenLayer, int par3)
    {
        Object object = par2GenLayer;

        for (int k = 0; k < par3; ++k)
        {
            object = new GenLayerZoom(par0 + (long)k, (GenLayerTofu)object);
        }

        return (GenLayerTofu)object;
    }
}
