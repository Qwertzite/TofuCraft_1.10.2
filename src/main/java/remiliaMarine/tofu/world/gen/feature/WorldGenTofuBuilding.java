...
public class WorldGenTofuBuilding extends WorldGenerator {
    ...
    {
        this(notify, 3, TcBlocks.tofuTerrain.getDefaultState());
    }
    ...
    {
        WorldGenerator var6 = new WorldGenTallGrassRanged((BlockBush) TcBlocks.leek, TcBlocks.leek.getDefaultState().withProperty(BlockLeek.META, BlockLeek.META_NATURAL), r);
