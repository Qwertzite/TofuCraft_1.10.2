...
public class ParticleTofuSmoke extends Particle {

    private double orginalPosY;
    private double orginalPosX;
    private double orginalPosZ;

    public ParticleTofuSmoke(World par1World, double par2, double par4, double par6, double par8, double par10, double par12)
    {
