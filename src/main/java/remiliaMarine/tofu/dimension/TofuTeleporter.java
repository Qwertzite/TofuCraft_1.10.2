...
public class TofuTeleporter extends Teleporter {
    ...
    public static final IBlockState FRAME_BLOCK = TcBlocks.tofuGrilled.getDefaultState();
    public static final BlockTofuPortal PORTAL_BLOCK = TcBlocks.tofuPortal;
...
label1:
	...
	public boolean makePortal(Entity entityIn) {
        ...
        // Place blocks
        {
        ModLog.debug("k1=%d, k5=%d, l5=%d", l1 % 4, l6, i3);
        ...
        for (int i8 = 0; i8 < 4; ++i8)
        {
            for (int l8 = 0; l8 < 4; ++l8)
            {
                for (int l9 = -1; l9 < 4; ++l9)
                {
                    ...
                    this.worldServerInstance.setBlockState(new BlockPos(l10, l11, k12), flag1 ? FRAME_BLOCK.withProperty(BlockTofuGrilled.FACING, EnumFacing.getFront(frameMeta)) : iblockstate, 2);
                }
            }
