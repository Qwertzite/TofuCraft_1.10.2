...
import remiliaMarine.tofu.util.GuiUtils;

public abstract class GuiTfMachineBase extends GuiMachineBase {
    ...
    public void drawItemStack(ItemStack stackIn, int x, int y)
    {
        GL11.glTranslatef(0.0F, 0.0F, 32.0F);
        this.zLevel = 200.0F;
        itemRender.zLevel = 200.0F;
        FontRenderer font = null;
        if (stackIn != null) font = stackIn.getItem().getFontRenderer(stackIn);
        itemRender.renderItemAndEffectIntoGUI(stackIn, x, y);
        itemRender.renderItemOverlayIntoGUI(font, stackIn, x, y, null);
        this.zLevel = 0.0F;
    ...
    public void drawTfHoveringText(List<String> par1List, int par2, int par3)
    {
        this.drawTfHoveringText(par1List, par2, par3, HoverTextPosition.UPPER_CENTER);
    }

    public void drawTfHoveringText(List<String> par1List, int par2, int par3, HoverTextPosition pos)
    {
        this.drawTfHoveringText(par1List, par2, par3, pos, COLOR_TIP_TEXT);
    }

    public void drawTfHoveringText(List<String> par1List, int par2, int par3, HoverTextPosition pos, int color)
    {
