package remiliaMarine.tofu.api;
...
public class TfMaterialRegistry {
    ...
    public static void init()
    {
        ...
        registerMaterial(TcItems.materials, ItemTcMaterials.EnumTcMaterialInfo.tofuGem.getMetadata(), 600);
        registerMaterial(TcItems.tofuHell, 150);
        registerMaterial(TcBlocks.tofuHell, 600);
        registerMaterial(TcItems.materials, ItemTcMaterials.EnumTcMaterialInfo.tofuDiamondNugget.getMetadata(), 200);
